...
* **Google BigQuery**
  ...
  I den här nya versionen har Federated Audience Composition stöd för säkra VPN-anslutningar till Google BigQuery-databaser. [Läs mer](../connections/federated-db.md#google-bigquery)
