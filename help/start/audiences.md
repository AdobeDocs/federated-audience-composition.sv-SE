...
Med Experience Platform Federated Audience Composition kan du [skapa kompositioner](../compositions/home.md), där du kan använda olika aktiviteter på en visuell arbetsyta för att skapa målgrupper och lagra dem i Adobe Experience Platform Audience Portal.
...
Målgrupper som skapats med Adobe Federated Data Composition innehåller alla fält som har markerats i aktiviteten **[!UICONTROL Save audience]** och lagras i Audience Portal tillsammans med alla Adobe Experience Platform-målgrupper.
