...
## juliversion 2025 {#fac-25-7}

Den här versionen innehåller följande ändringar och förbättringar:

* **Oracle-anslutningstillgänglighet**

  Oracle-anslutningen är nu tillgänglig för användning med Federated Audience Composition.

* **Varningar om kompositionsstatus**

  Du kan prenumerera på varningar för att få meddelanden om att kompositionen har slutförts och misslyckats.
...
* **Datamodellens arbetsytevy**
  ...
  Arbetsytans vy för avsnittet Datamodeller förbättrar upplevelsen genom att aktivera visualisering av datamodeller och deras länkar i en arbetsytelayout, tillsammans med den befintliga tabellvyn. [Läs mer](../data-modelling/models.md)
...
* **Snowflake säker anslutning**
  ...
  Med den här nya versionen har Federated Audience Composition stöd för säkra privata länkanslutningar till Amazon Redshift-databaser på Microsoft Azure. [Läs mer](../connections/home.md#amazon-redshift)
...
>[!AVAILABILITY]
>
>Adobe Experience Platform Federated Audience Composition Composition är tidigare tillgängligt för en uppsättning organisationer (LA) och är nu tillgängligt för alla användare (GA). Den här funktionen aktiveras baserat på ditt erbjudande och visas endast med tillhörande behörigheter. [Läs mer](../start/access-prerequisites.md)
>
...
* **Uppdatera befintliga scheman**
  ...
  När en kolumn skapas, ändras eller tas bort i en federerad databas kan du nu identifiera och tillämpa ändringarna genom att välja **[!UICONTROL Refresh schema]** i motsvarande schema. [Läs mer](../data-modelling/schemas.md#schema-refresh)
...
Läs mer om funktionerna för federerad målgruppskomposition på [den här sidan](../overview.md) och i [Vanliga frågor](../faq.md).

Detaljerad information om förutsättningarna för att komma åt Federated Audience Compositions och aktuella skyddsutkast finns på [den här sidan](../start/access-prerequisites.md).
