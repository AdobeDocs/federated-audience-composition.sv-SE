---
audience: end-user
title: Fråga Modeler - översikt
description: Lär dig hur du använder frågemodelleraren för att definiera regler för att filtrera databasen.
...
# Översikt över frågemodelleraren {#query-modeler}
...
| **Anpassa aktiviteter**: Använd regler i dispositionsaktiviteter, som **Dela** och **Avstämning**, för att anpassa dem efter dina specifika krav. [Läs mer om dispositionsaktiviteter](../compositions/activities.md) | ![](assets/access-composition.png){zoomable="yes"}{width="200" align="center" zoomable="yes"} |
