...
![Ett arbetsflöde för exempeldisposition visas i Federated Audience Composition.](assets/compositions/composition-example.png){zoomable="yes"}{width="70%"}

## Komponenter i disposition {#components}

En komposition i Federated Audience Composition består av följande delar:

- **[!UICONTROL Activities]**: En aktivitet är en aktivitet som ska utföras och som representeras av ikoner i dispositionen.
- **[!UICONTROL Transitions]**: Övergångar länkar en källaktivitet till en målaktivitet och definierar deras sekvens. Informationen som finns i övergångarna lagras i en arbetstabell. Varje komposition använder flera arbetstabeller. De data som förmedlas i dessa tabeller kan användas under hela kompositionens livscykel.
...
Du kan lära dig att starta eller stoppa en disposition i [skaparguiden](./create-composition.md#monitor-logs).

![En lista över tillgängliga kompositioner visas.](assets/compositions/compositions-list.png){zoomable="yes"}{width="70%"}
...
![En lista över tillgängliga kolumner som du kan lägga till på kompositionsbläddringssidan visas.](assets/compositions/compositions-columns.png){zoomable="yes"}{width="70%"}
...
![Knappen Hantera åtkomst är markerad på dispositionsarbetsytan.](assets/compositions/select-manage-access.png){zoomable="yes"}{width="70%"}
...
![Åtkomstporten Hantera visas. Här visas en lista med alla tillgängliga etiketter som du kan använda för kompositionen.](assets/compositions/manage-access.png){zoomable="yes"}{width="70%"}
...
Du kan skapa en komposition för Adobe Experience Platform med Audience Composition. Mer information finns i [Skapa en kompositionsguide](./create-composition.md).
