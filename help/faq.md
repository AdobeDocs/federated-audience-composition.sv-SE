...
För att kunna använda federerad målgruppskomposition måste varje användare läggas till i en specifik profil som skapas för varje sandlåda. Mer information finns på sidan [Access Federated Audience Composition](./start/access-prerequisites.md) .
...
Följande molnlager stöds för närvarande:
...
Mer information om hur du ansluter till ett datalager finns i [anslutningsöversikten](./connections/home.md).
...
## Lagrar Federated Audience Composition en fysisk kopia av den listan med personer som ska skickas till system längre fram i kedjan?
...
## Om data för målgruppsskapande och målgruppsberikning inte bevaras, hur lagras de då tillfälligt?
...
Ja, du kan ta bort grupper med sammansatta målgrupper (Federated Audience Composition) i Audience Portal.

+++

## Hur sammanfogar vi data om jag kombinerar data från flera källor? Använder vi identitetstjänsten?
...
## Hur skapar och hanterar jag sekretessförfrågningar med Federated Audience Composition?
